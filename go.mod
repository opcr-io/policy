...
replace oras.land/oras-go/v2 v2.0.0 => github.com/opcr-io/oras-go/v2 v2.0.0-20230331095552-41df01dce636

replace go.opentelemetry.io/otel/metric => go.opentelemetry.io/otel/metric v0.34.0
...
require (
	...
	github.com/opcr-io/policy/parser v0.0.0-20230619114534-73c6ea929b7d
