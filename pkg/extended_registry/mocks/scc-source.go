...
func (m *MockSource) CreateRepo(arg0 context.Context, arg1 *sources.AccessToken, arg2, arg3 string, arg4 *sources.Commit) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateRepo", arg0, arg1, arg2, arg3, arg4)
	ret0, _ := ret[0].(error)
	return ret0
}

// CreateRepo indicates an expected call of CreateRepo.
func (mr *MockSourceMockRecorder) CreateRepo(arg0, arg1, arg2, arg3, arg4 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateRepo", reflect.TypeOf((*MockSource)(nil).CreateRepo), arg0, arg1, arg2, arg3, arg4)
}
...
func (m *MockSource) ListOrgs(arg0 context.Context, arg1 *sources.AccessToken, arg2 *api.PaginationRequest) ([]string, *api.PaginationResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockSource) ValidateConnection(arg0 context.Context, arg1 *sources.AccessToken) (*http.Response, error) {
	m.ctrl.T.Helper()
